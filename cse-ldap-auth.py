...
CACERTFILE='/home/dheerendra/PycharmProjects/networks/cse-cacert.pem'
...
result = conn.search_s('dc=cse,dc=iitb,dc=ac,dc=in', ldap.SCOPE_SUBTREE, 'uid=dheerendra', ['uid','employeeNumber', 'cn'])
password = 'password'
